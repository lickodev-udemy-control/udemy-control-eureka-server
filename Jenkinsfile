pipeline {
    ...
    post {
        ...
        success {
                ...
                emailext(from: 'Saul Es Tu Dios, :3', body: 'Se contruyó satisfactoriamente', subject: 'EXITO!', to: 'saul.avila.dev@outlook.com', attachmentsPattern: 'target/*.jar.original')
                echo 'Success'
        }
    }
}
